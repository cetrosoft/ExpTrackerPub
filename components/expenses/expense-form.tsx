...
export function ExpenseForm({ expense, onSuccess, onCancel }: ExpenseFormProps) {
  ...
  // Update form when expense changes (for editing)
  useEffect(() => {
    if (expense) {
      form.setValue("title", expense.title || "")
      form.setValue("amount", expense.amount || 0)
      form.setValue("category_id", expense.category_id || "")
      form.setValue("currency_code", expense.currency_code || "EGP")
      form.setValue(
        "date",
      ...
      form.setValue("tags", expense.tags || [])
    }
  }, [expense, form])
